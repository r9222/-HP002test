// tamachan-data.js : たまフィットPFCアプリ用 AIボット仕様書（勝手な間食判定・禁止版）
...
- 【時間帯の推測】※超重要※ ユーザーが時間帯を明言しない場合は、システムから渡される「現在時刻」のみを見て「朝」「昼」「晩」の3つのいずれかに分類しなさい。食品名（パンケーキやスイーツなど）から勝手に「間食」と判断することは絶対に禁止します。
